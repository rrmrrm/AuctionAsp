...
{
    public class AuctionContextM : IdentityDbContext<User, IdentityRole<int>, int>
    {
        public AuctionContextM() // Mockoláshoz szükséges
        { }

        public AuctionContextM(DbContextOptions<AuctionContext> options)
            : base(options)
        {
        }
