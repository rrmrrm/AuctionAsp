...
namespace Auction.Persistence.Services
{
    public class AccountService
    {
        ...
        public AccountService(AuctionContext c, IHttpContextAccessor httpContextAccessor/*, ApplicationState _applicationState*/)
        {
                ...
                !httpContext.Session.Keys.Contains("user"))
            {
                User guest = context.Users.FirstOrDefault(
                    g => g.SecurityStamp == httpContext.Request.Cookies["user_challenge"]);
        ...
        public Boolean Login(LoginViewModel user)
        {
            ...
            // replacement code: for expression passwordBytes.SequenceEqual(foundUser.PasswordHash) 
            var b1 = passwordBytes;
            var b2 = foundUser.PasswordHash;
            ...
            {
                httpContext.Response.Cookies.Append("user_challenge", foundUser.SecurityStamp,
                    new CookieOptions
                    {
...
*/
        ...
        public Boolean Register(RegistrationViewModel user)
        {
            ...
            context.Users.Add( new User 
            {
                ...
                Email = user.Email,
                PasswordHash = passwordBytes.ToString(),
