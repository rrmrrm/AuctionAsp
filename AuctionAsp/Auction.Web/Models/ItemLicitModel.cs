...
namespace Auction.Persistence
{
    public class ItemLicitModel
    {
        ...
        public ItemLicitModel() { }

        public ItemLicitModel(Int32 ItemId, String ItemName, DateTime AuctionStartDate, DateTime AuctionCloseDate,
